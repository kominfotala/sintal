                            ...
                            <div class="card-header">
                                ...
                                <div class="heading-elements">
                                    <ul class="list-inline mb-0">
                                        <div class="btn-group">
                                            <a href="<?=site_url()?>idcard/add/pppk" class="btn btn-outline-primary"><i
                                                    class="ft-plus"></i>
                                                Tambah</a>
                                        ...
                                        <table class="table table-hover table-bordered zero-configuration">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="<?= site_url()?>cetak/pppk/<?=$row['id_p3k']?>"
                                                                class="btn btn-sm btn-outline-info"><i
                                                                    class="ft-file"></i>
                                                                Cetak</a>
                                                            <a href="<?= site_url()?>idcard/edit/pppk/<?=$row['id_p3k']?>"
                                                                class="btn btn-sm btn-outline-success"><i
                                                                    class="ft-edit"></i> Edit</a>
                                                            <button class="btn btn-sm btn-outline-danger hapus"
                                                                data-id="<?=$row['id_p3k']?>" data-toggle="modal"
                                                                data-target="#default">
                                                    ...
                                                    <td><img src="<?= base_url().$row['foto']?>" alt="" width="100">
                                                    </td>
                                                    <td><?= $row['nip']?></td>
                                                    <td><?= $row['nama']?></td>
                                                    <td><?= $row['jabatan']?></td>
                ...
                <div class="modal fade text-left" id="default" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <?= form_open(site_url('idcard/delete/pppk'))?>
