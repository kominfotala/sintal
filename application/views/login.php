...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>template/app-assets/css/pages/login-register.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu 1-column   blank-page blank-page" data-open="click" data-menu="vertical-menu"
                            ...
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header border-0">
                                    <div class="card-title text-center">
                                        <!-- <div class="p-1"><img
                                                src="<?=base_url()?>template/app-assets/images/logo/stack-logo-dark.png"
    ...
    <script src="<?=base_url()?>template/app-assets/vendors/js/forms/icheck/icheck.min.js"></script>
    <script src="<?=base_url()?>template/app-assets/vendors/js/forms/validation/jqBootstrapValidation.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?=base_url()?>template/app-assets/js/scripts/forms/form-login-register.js"></script>
    <!-- END: Page JS-->
