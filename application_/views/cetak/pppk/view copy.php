                    ...
                    <div class="col-md-6">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <input type="hidden" name="" id="id" value="<?=$data['id_p3k']?>">
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-12 mb-1">
                                            <div id="belakang">
                                                ...
                                                <div class="template_belakang">
                                                    <img src="<?=base_url()?>asset/template/belakang.png" alt=""
                                                        width="400">
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="range" name="" value="212" id="posisi_jabatan" min="200"
                                                    max="230" class="form-control">
                                            </fieldset>
                                        </div>
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="range" name="" value="264" id="posisi_alamat" min="250"
