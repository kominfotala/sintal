            ...
            <section class="basic-elements">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <?= form_open_multipart()?>
                            <input type="hidden" id="id" name="id" value="<?=$data['id_p3k']?>">
                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                <label for="basicInput">Intansi</label>
                                                <select name="id_skpd" id="id_skpd" class="select2  form-control"
                                                    required>
                                                    <option value="">Pilih</option>
                                                    <?php foreach($instansi as $row) :?>
                                                    <option <?= selected($data['id_skpd'],$row['id_skpd'])?>
                                                        value="<?=$row['id_skpd']?>"><?=$row['nama_skpd']?>
                                                    </option>
                                        ...
                                        <div class="col-xl-12 col-lg-6 col-md-12 mb-1">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" name="jabatan" value="<?=$data['jabatan']?>"
                                                    id="jabatan" class="form-control" required>
                                            </fieldset>
                                        </div>
                                ...
                                <div class="card-footer">
                                    <a href="<?= site_url('idcard/page/pppk')?>"> <button type="button"
