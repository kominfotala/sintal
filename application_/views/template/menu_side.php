  ...
  <div class="main-menu menu-fixed menu-light menu-accordion" data-scroll-to-active="true">
      <div class="main-menu-content">
          <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
              ...
              <li class="<?php if(isset($mn_beranda)) {echo "active";}?> nav-item"><a href="<?=site_url('beranda')?>"><i
                          class="ft-home"></i><span class="menu-title" data-i18n="">Beranda</span></a>
              </li>


              <li class=" nav-item"><a href="#"><i class="ft-user"></i><span class="menu-title" data-i18n="">ID
                          Card</span></a>
                  <ul class="menu-content">
                      <li <?php if(isset($mn_idcard_asn)) {echo "class='active'";}?>><a class="menu-item"
                              href="<?=site_url('idcard/page/asn')?>">PNS</a>
                      </li>
                      <li <?php if(isset($mn_idcard_p3k)) {echo "class='active'";}?>><a class="menu-item"
                              href="<?=site_url('idcard/page/pppk')?>">PPPK</a>
                      </li>
                      <li <?php if(isset($mn_idcard_ptt)) {echo "class='active'";}?>><a class="menu-item"
                              href="<?=site_url('idcard/page/ptt')?>">PTT</a>
                      </li>


                  </ul>
              </li>
              <li class=" navigation-header"><span>APP</span><i class=" ft-minus" data-toggle="tooltip"
                      data-placement="right" data-original-title="App"></i>
              </li>
              <li class="<?php if(isset($mn_instansi)) {echo "active";}?> nav-item"><a
                      href="<?=site_url('instansi')?>"><i class="ft-globe"></i><span class="menu-title"
                          data-i18n="">Instansi</span></a>
              </li>
              <li class="<?php if(isset($mn_user)) {echo "active";}?> nav-item"><a href="<?=site_url('user')?>"><i
                          class="ft-user"></i><span class="menu-title" data-i18n="">User</span></a>
              </li>
              <li class="<?php if(isset($mn_pengaturan)) {echo "active";}?> nav-item"><a
                      href="<?= site_url('pengaturan')?>"><i class="fa fa-sliders"></i><span class="menu-title"
                          data-i18n="">Pengaturan</span></a>
              </li>
                  ...
                  <ul class="menu-content">
                      <li><a class="menu-item" href="#">Page Layouts</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                                  <ul class="menu-content">
                                      <li><a class="menu-item" href="layout-content-detached-left-sidebar.html">Detached
                                              left sidebar</a>
                                      </li>
                                      <li><a class="menu-item"
                                              href="layout-content-detached-left-sticky-sidebar.html">Detached sticky
                                              left sidebar</a>
                                      </li>
                                      <li><a class="menu-item"
                                              href="layout-content-detached-right-sidebar.html">Detached right
                                              sidebar</a>
                                      </li>
                                      <li><a class="menu-item"
                                              href="layout-content-detached-right-sticky-sidebar.html">Detached sticky
                                              right sidebar</a>
                                      </li>
                                  </ul>
                              </li>
                              ...
                              <li><a class="menu-item" href="layout-fixed-navbar-footer.html">Fixed navbar &amp;
                                      footer</a>
                              </li>
                              <li class="navigation-divider"></li>
                      ...
                      <li><a class="menu-item" href="#">Navbars</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="#">Hide on Scroll</a>
                                  <ul class="menu-content">
                                      <li><a class="menu-item" href="navbar-hide-on-scroll-top.html">Hide on Scroll
                                              Top</a>
                                      </li>
                                      <li><a class="menu-item" href="navbar-hide-on-scroll-bottom.html">Hide on Scroll
                                              Bottom</a>
                                      </li>
                                  </ul>
                              </li>
                          ...
                          <ul class="menu-content">
                              <li><a class="menu-item" href="#">Navigation Types</a>
                                  <ul class="menu-content">
                                      ...
                                      <li><a class="menu-item" href="../vertical-overlay-menu-template">Vertical
                                              Overlay</a>
                                      </li>
                                  </ul>
                              </li>
                      ...
                      <li><a class="menu-item" href="#">Page Headers</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="headers-breadcrumbs-with-button.html">Breadcrumbs with
                                      button</a>
                              </li>
                              <li><a class="menu-item" href="headers-breadcrumbs-with-round-button.html">Breadcrumbs
                                      with round button 2</a>
                              </li>
                              <li><a class="menu-item" href="headers-breadcrumbs-with-stats.html">Breadcrumbs with
                                      stats</a>
                              </li>
                          </ul>
                      </li>
              ...
              <li class=" nav-item"><a href="#"><i class="ft-zap"></i><span class="menu-title" data-i18n="">Starter
                  ...
                  <ul class="menu-content">
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-1-column.html">1
                              column</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-2-columns.html">2
                              columns</a>
                      </li>
                      <li><a class="menu-item" href="#">Content Det. Sidebar</a>
                          <ul class="menu-content">
                              <li><a class="menu-item"
                                      href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-left-sidebar.html">Detached
                                      left sidebar</a>
                              </li>
                              <li><a class="menu-item"
                                      href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-left-sticky-sidebar.html">Detached
                                      sticky left sidebar</a>
                              </li>
                              <li><a class="menu-item"
                                      href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-right-sidebar.html">Detached
                                      right sidebar</a>
                              </li>
                              <li><a class="menu-item"
                                      href="../../../starter-kit/ltr/vertical-menu-template-light/layout-content-detached-right-sticky-sidebar.html">Detached
                      ...
                      <li class="navigation-divider"></li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar.html">Fixed
                              navbar</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navigation.html">Fixed
                              navigation</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar-navigation.html">Fixed
                              navbar &amp; navigation</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed-navbar-footer.html">Fixed
                              navbar &amp; footer</a>
                      </li>
                      <li class="navigation-divider"></li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-fixed.html">Fixed
                              layout</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-boxed.html">Boxed
                              layout</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-static.html">Static
                              layout</a>
                      </li>
                      <li class="navigation-divider"></li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-light.html">Light
                              layout</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-dark.html">Dark
                              layout</a>
                      </li>
                      <li><a class="menu-item"
                              href="../../../starter-kit/ltr/vertical-menu-template-light/layout-semi-dark.html">Semi
                              dark layout</a>
                      </li>
                  </ul>
              </li>
              <li class=" navigation-header"><span>Apps</span><i class=" ft-minus" data-toggle="tooltip"
                      data-placement="right" data-original-title="Apps"></i>
              </li>
              <li class=" nav-item"><a href="app-email.html"><i class="ft-mail"></i><span class="menu-title"
                          data-i18n="">Email Application</span></a>
              </li>
              <li class=" nav-item"><a href="app-chat.html"><i class="ft-message-square"></i><span class="menu-title"
                          data-i18n="">Chat Application</span></a>
              </li>
              <li class=" nav-item"><a href="app-todo.html"><i class="ft-check-square"></i><span class="menu-title"
                          data-i18n="">Todo Application</span></a>
              </li>
              <li class=" nav-item"><a href="app-contacts.html"><i class="ft-users"></i><span class="menu-title"
                          data-i18n="">Contacts</span></a>
              </li>
              <li class=" nav-item"><a href="project-summary.html"><i class="ft-airplay"></i><span class="menu-title"
                          data-i18n="">Project Summary</span></a>
              </li>
              <li class=" nav-item"><a href="invoice-template.html"><i class="ft-printer"></i><span class="menu-title"
                          data-i18n="">Invoice Template</span></a>
              </li>
              <li class=" nav-item"><a href="#"><i class="ft-share"></i><span class="menu-title"
                          data-i18n="">Timelines</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-plus-square"></i><span class="menu-title"
                          data-i18n="">Calender</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-image"></i><span class="menu-title"
              ...
              <li class=" nav-item"><a href="#"><i class="ft-search"></i><span class="menu-title"
                          data-i18n="">Search</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-unlock"></i><span class="menu-title"
                          data-i18n="">Authentication</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-alert-triangle"></i><span class="menu-title"
                          data-i18n="">Error</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-watch"></i><span class="menu-title" data-i18n="">Coming
                          Soon</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="under-maintenance.html"><i class="ft-cloud-off"></i><span
                          class="menu-title" data-i18n="">Maintenance</span></a>
              </li>
              <li class=" navigation-header"><span>UI</span><i class="ft-droplet ft-minus" data-toggle="tooltip"
                      data-placement="right" data-original-title="UI"></i>
              </li>
              <li class=" nav-item"><a href="#"><i class="ft-globe"></i><span class="menu-title"
                          data-i18n="">Content</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-square"></i><span class="menu-title"
                          data-i18n="">Cards</span><span
              ...
              <li class=" nav-item"><a href="#"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Advance
                          Cards</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-droplet"></i><span class="menu-title" data-i18n="">Color
                          Palette</span><span
              ...
              <li class=" nav-item"><a href="#"><i class="ft-eye"></i><span class="menu-title"
              ...
              <li class=" navigation-header"><span>Components</span><i class=" ft-minus" data-toggle="tooltip"
                      data-placement="right" data-original-title="Components"></i>
              </li>
              <li class=" nav-item"><a href="#"><i class="ft-briefcase"></i><span class="menu-title"
                          data-i18n="">Bootstrap Components</span></a>
                  <ul class="menu-content">
              ...
              <li class=" nav-item"><a href="#"><i class="ft-box"></i><span class="menu-title" data-i18n="">Extra
                          Components</span></a>
                  <ul class="menu-content">
                  ...
                  <ul class="menu-content">
                      ...
                      <li><a class="menu-item" href="#">DataTables</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="#" data-i18n="nav.datatable_extensions.main">DataTables
                                      Ext.</a>
                                  <ul class="menu-content">
                  ...
                  <ul class="menu-content">
                      <li><a class="menu-item" href="#">Echarts</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="echarts-pie-doughnut-charts.html">Pie &amp; Doughnut
                                      charts</a>
                              </li>
                              <li><a class="menu-item" href="echarts-scatter-charts.html">Scatter charts</a>
                              </li>
                              <li><a class="menu-item" href="echarts-radar-chord-charts.html">Radar &amp; Chord
                                      charts</a>
                              </li>
                              <li><a class="menu-item" href="echarts-funnel-gauges-charts.html">Funnel &amp; Gauges
                                      charts</a>
                              </li>
                      ...
                      <li><a class="menu-item" href="#">Chartjs</a>
                          <ul class="menu-content">
                              ...
                              <li><a class="menu-item" href="chartjs-pie-doughnut-charts.html">Pie &amp; Doughnut
                                      charts</a>
                              </li>
                              <li><a class="menu-item" href="chartjs-scatter-charts.html">Scatter charts</a>
                              </li>
                              <li><a class="menu-item" href="chartjs-polar-radar-charts.html">Polar &amp; Radar
                                      charts</a>
                              </li>
              ...
              <li class=" navigation-header"><span>Others</span><i class=" ft-minus" data-toggle="tooltip"
                      data-placement="right" data-original-title="Others"></i>
              </li>
              <li class=" nav-item"><a href="#"><i class="ft-align-left"></i><span class="menu-title" data-i18n="">Menu
                          levels</span></a>
                  <ul class="menu-content">
              ...
              <li class="disabled nav-item"><a href="#"><i class="ft-slash"></i><span class="menu-title"
                          data-i18n="">Disabled Menu</span></a>
              </li>
